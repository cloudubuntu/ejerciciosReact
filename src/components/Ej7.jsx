...
const Ej7 = () => {
    let empleados = [
        ...
        "Engineering", pic: "empleado06.png" },{ id: 7, fullName: "Ellen Balderas", title: "Digital Strategist",
    ...
    return (
        <div className='border border-5 border-dark p-2'>
            <Container className='border border-2 border-danger'>
